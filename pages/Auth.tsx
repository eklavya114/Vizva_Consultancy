...
const Auth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start p-8 relative overflow-hidden bg-[#12151e]">
          ...
          <div className="w-full max-w-lg bg-[#1a1e2b]/95 border border-white/20 rounded-[40px] p-10 flex flex-col items-center shadow-[0_60px_100px_rgba(0,0,0,0.6)] animate-in zoom-in-95 duration-700 relative overflow-hidden group">
            ...
            <form onSubmit={handleClientAuth} className="w-full space-y-6">
              ...
              <div className="flex items-center gap-6 py-2">
                ...
                <span className="text-[8px] font-black text-white/30 uppercase tracking-[0.4em] whitespace-nowrap">or secure through</span>
                <div className="h-[1px] flex-1 bg-white/10"></div>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <button type="button" className="flex items-center justify-center gap-3 py-4 rounded-[20px] bg-[#12151e] border border-white/10 text-[10px] font-black uppercase tracking-[0.4em] text-white/50 hover:bg-white/5 hover:text-white transition-all">
      ...
      <div className="fixed inset-0 pointer-events-none opacity-[0.03] flex items-center justify-center -z-10 select-none">
        <span className="text-[35vw] font-black uppercase tracking-tighter italic text-blue-800">VIZVA</span>
      </div>
    </div>
  );
};
