...
/**
 * Compliance Triage Center
 * Displays tickets awaiting initial department allocation.
 * Only accessible to the Compliance Manager role.
 */
import React, { useState } from 'react';
import { useApp } from '../store/AppContext';
import { GlobalStatus } from '../types';
import { ShieldCheck, Search, Filter, ChevronRight, Clock } from 'lucide-react';
