...
/**
 * Parallel Resolution Table
 * Displays all departmental assignments for a given ticket.
 * Handles Team Lead assignment and departmental status updates.
 */
import React from 'react';
import { DepartmentAssignment, AssignmentStatus, Role } from '../types';
import { useApp } from '../store/AppContext';
import { ASSIGNMENT_STATUS_COLORS } from '../constants';
import { UserCheck, Clock, MapPin, Activity, UserPlus, MoreVertical } from 'lucide-react';
