...
/**
 * CTS UI Constants
 * Defines visual mappings and service-level agreement (SLA) configurations.
 */
import { Priority, GlobalStatus, AssignmentStatus } from './types';

export const SLA_HOURS_URGENT = 4;
export const PHONE_PREFIX = '+1';

/** Color protocol for priority visualization */
...
/** Departmental sub-status themes */
